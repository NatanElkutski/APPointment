...
public class VacationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View itemview = inflater.inflate(R.layout.fragment_vacation, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        vactaionLLbtns = view.findViewById(R.id.vacation_btn_linear_id);
        vactaionLLbtns.setBackgroundResource(0);
        acceptbtn = view.findViewById(R.id.vacation_btn_accept_id);

        canacelVacbtn = view.findViewById(R.id.cancelVacations_btn_id);


        Date today = new Date();
        Calendar nextYear = Calendar.getInstance();
        nextYear.add(Calendar.YEAR, 1);
        datePicker = view.findViewById(R.id.calendar_view_grid);
